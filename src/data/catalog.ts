...
export const catalogProducts: CatalogProduct[] = [
  ...
  { id: 'pvc-floor', sku: 'PVC-40X40', nombre: 'Piso PVC 40x40', categoria: 'pvc', descripcion: 'Piso modular de alto tránsito', precio: 2000, impuesto: 0, tamano: '40 x 40 cm', estiloFoto: 'textures/azul.png', stock: 50, garantia: '12 meses', cuentaCobro: 'Ventas PVC', cuentasPago: cuentasBase },
  { id: 'pvc-borders', sku: 'PVC-BORDE', nombre: 'Borde PVC', categoria: 'pvc', descripcion: 'Borde para perímetro', precio: 800, impuesto: 0, tamano: 'pieza', estiloFoto: 'textures/azul.png', stock: 50, garantia: '12 meses', cuentaCobro: 'Ventas PVC', cuentasPago: cuentasBase },
  { id: 'pvc-corners', sku: 'PVC-ESQ', nombre: 'Esquinero PVC', categoria: 'pvc', descripcion: 'Pieza de esquina', precio: 200, impuesto: 0, tamano: 'pieza', estiloFoto: 'textures/azul.png', stock: 50, garantia: '12 meses', cuentaCobro: 'Ventas PVC', cuentasPago: cuentasBase },
  { id: 'wpc-interior', sku: 'WPC-INT', nombre: 'Panel WPC Interior', categoria: 'wpc', descripcion: 'Panel decorativo interior', precio: 3990, impuesto: 0, tamano: '16cm x 2.90m', estiloFoto: 'textures/BRONCE.png', stock: 50, garantia: '24 meses', cuentaCobro: 'Ventas WPC', cuentasPago: cuentasBase },
  { id: 'wpc-exterior', sku: 'WPC-EXT', nombre: 'Panel WPC Exterior', categoria: 'wpc', descripcion: 'Panel decorativo exterior', precio: 9990, impuesto: 0, tamano: '22cm x 2.90m', estiloFoto: 'textures/BRONCE.png', stock: 50, garantia: '24 meses', cuentaCobro: 'Ventas WPC', cuentasPago: cuentasBase },
  { id: 'wpc-coextruido', sku: 'WPC-COEX', nombre: 'Panel WPC Coextruido', categoria: 'wpc', descripcion: 'Panel premium coextruido', precio: 14000, impuesto: 0, tamano: '22cm x 2.90m', estiloFoto: 'textures/BRONCE.png', stock: 50, garantia: '24 meses', cuentaCobro: 'Ventas WPC', cuentasPago: cuentasBase },
